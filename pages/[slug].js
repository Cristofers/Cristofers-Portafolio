...
function Post(props) {
  ...
  const title = `${props.title} // Cristofers Valdez`
  const description = props.description || ''
  const url = `https://cristofers.com/${props.slug}`
  const date = new Date(props.date).toISOString()
  const image = props.image
    ? `https://cristofers.com${props.image}`
    : 'https://cristofers.com/static/images/home-opt.jpg'
